...
########################
model = YOLO("yolo/models/yolo11n.pt").to("cuda:0")  # Load YOLO model and move it to GPU
model.half()
model.train(
    data="./datasets/pallet_detection_dataset/data.yaml",  # Path to dataset YAML file
...
quantized_model_path = "yolo/models/optimized_models_detection/quantized_yolo_model.pt"
...
#######################
onnx_model_path = "yolo/models/optimized_models_detection/model_fp16.onnx"
...
# Convert to tensorRT
###############
tensorrt_model_path = "yolo/models/optimized_models_detection/model_fp16_int8.trt"
