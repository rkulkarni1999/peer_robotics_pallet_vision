...
model = YOLO("yolo/models/models_old/pallet_segmentation.pt")
model = model.to("cuda:0") 

# Directory containing images
image_dir = "data/warehouse_data" 

output_dir_semantic = "yolo/inferences/segmentation/yolo_semantic_segmentation/"  # Directory to save semantic overlay
output_dir_bbox = "yolo/inferences/segmentation/yolo_bbox_overlay/"  # Directory to save bounding box overlay
...
for idx, image_file in enumerate(image_files):
    ...
    results = model.predict(source=image_path, conf=0.45, save=False)  # Do not save individual instance masks yet
